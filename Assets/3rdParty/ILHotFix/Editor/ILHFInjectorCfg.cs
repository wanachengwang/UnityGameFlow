...
public class ILHFInjectorCfg : EditorWindow {
    ...
    public static List<string> PathToResolve { get { return _pathToResolve; } }
    ...
    void OnGUI() {
        ...
        _cfgWindow.position = new Rect(_cfgWindow.position.position, new Vector2(400, (_assembliesPathToInject.Count+2+ _methodsToInject.Count+2+ _pathToResolve.Count+2+1)*20));
    }
}
